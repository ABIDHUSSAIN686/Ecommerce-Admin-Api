...
app.include_router(sales_endpoints.api_router, prefix="/admin/v1/sales", tags=["Sales"])

# Register the inventory endpoints
# Tags help organize the autogenerated API docs
app.include_router(inventory_endpoint.api_router, prefix="/admin/v1/inventory", tags=["Inventory"])